...
def third_choice():
    response_three = input(
        'You come to the door, the flashing green keypad catches your attention. A question appears: "What always ends everything?" Please type in your answer.')
    time.sleep(1)
    if response_three == "g":
        ...
        time.sleep(1)
        print('[INSERT BASEMENT FUNCTION HERE]')
        # JAMES' CODE HERE
    else:
...
def second_choice():
    ...
    if response_two == "1":
        time.sleep(1)
        print("Appearances can be deceiving, they may look simple, however they are unbelieveably strong and with there being 2 of them they easily overpower you and subdue you. You have been captured. Game over.")
        time.sleep(1)
        first_choice()
    elif response_two == "2":
        print("Your faithful companion Hackerman received your cry for help and through sheer technical skill he was successfully able to set off an alarm on the 2nd floor, drawing the guards attention to the 2nd floor. The coast is clear, there is nothing in your way now.")
        time.sleep(1)
        third_choice()
...
def first_choice():
    ...
    time.sleep(1)
    print("The layout of this floor is very simple, as there is only one way to go. Forward.")
    time.sleep(1)
    ...
    if response == "left":
        ...
        print("You follow the other corridor and encounter a small wooden door with a rusty old door knob, a quick wiggle and shake of the handle triggers the 2nd floor alarm, alerting the entire building.")
        time.sleep(1)
        print("With the whole building being aware of your prescence there is no conceivable way you can carry on with this adventure.")
        time.sleep(1)
        print("Pity.")
        time.sleep(1)
        first_choice()
    # Create a function that takes you back to the start of the level if the player chooses "right"
    else:
